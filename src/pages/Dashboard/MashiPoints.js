      ...
      <div id="dashboard-layout" style="display: flex; min-height: 100vh;">
          ...
          <aside id="dash-sidebar" style="width: 280px; background: #fff; padding: 2rem; display: flex; flex-direction: column; border-right: 1px solid #eee; position: sticky; top: 0; height: 100vh;">
              <div class="logo" style="margin-bottom: 4rem;">
                  <h2 style="font-size: 1.8rem; letter-spacing: -1px; font-weight: 900; cursor: pointer;">MASHI</h2>
              </div>
              ...
              <nav style="flex: 1;">
                  <ul style="list-style: none; display: flex; flex-direction: column; gap: 0.5rem; padding: 0;">
                      ...
                      <li class="dash-nav-item active" style="border-radius: 12px; cursor: pointer; background: #f0f0f0;">
                        <a href="/points" style="padding: 1rem; display: flex; align-items: center; gap: 12px; font-weight: 600; font-size: 0.9rem; color: #000; text-decoration: none; width: 100%;">
          ...
          <main style="flex: 1; padding: 3rem;">
              <header style="margin-bottom: 4rem;">
                  <h1 style="font-size: 2.5rem; letter-spacing: -1px; font-weight: 800;">Mashi Points</h1>
                  <p style="color: #999; font-size: 0.9rem; margin-top: 0.5rem;">Your loyalty balance and studio rewards.</p>
              </header>

              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2.5rem;">
                  <div style="background: #000; padding: 3rem; border-radius: 30px; color: #fff; position: relative; overflow: hidden;">
                      <div style="position: relative; z-index: 2;">
                          <span style="font-size: 0.8rem; color: #999; text-transform: uppercase; letter-spacing: 2px;">Total Balance</span>
                          <h2 style="font-size: 4rem; margin: 1.5rem 0; font-weight: 800;">8,678</h2>
                          <p style="font-size: 0.9rem; opacity: 0.7;">Equivalent to $86.78 in studio credits</p>
                      </div>
                      <i data-lucide="coins" style="position: absolute; right: -2rem; bottom: -2rem; width: 200px; height: 200px; opacity: 0.1; color: #fff;"></i>
                  </div>

                  <div style="background: #fff; padding: 3rem; border-radius: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.03);">
                      <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 2rem;">Redeem Rewards</h3>
                      <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                          <div class="flex-between" style="padding: 1rem; background: #f9f9f9; border-radius: 15px;">
                              <div>
                                  <h4 style="font-size: 0.9rem; font-weight: 700;">$10 Gift Card</h4>
                                  <p style="font-size: 0.75rem; color: #999;">1000 Points</p>
                              </div>
                              <button class="btn btn-dark" style="padding: 0.5rem 1rem; font-size: 0.7rem; border-radius: 8px;">Redeem</button>
                          </div>
                          <div class="flex-between" style="padding: 1rem; background: #f9f9f9; border-radius: 15px;">
                              <div>
                                  <h4 style="font-size: 0.9rem; font-weight: 700;">Free Shipping</h4>
                                  <p style="font-size: 0.75rem; color: #999;">500 Points</p>
                              </div>
                              <button class="btn btn-dark" style="padding: 0.5rem 1rem; font-size: 0.7rem; border-radius: 8px;">Redeem</button>
                          </div>
                      </div>
