    ...
    <div style="background: #fff; border-top: 1px solid var(--border-light); padding: 80px 0 40px;">
      <div class="container">
        <div style="text-align: center;">
          ...
          <div class="flex" style="justify-content: center; gap: 3rem; margin-bottom: 4rem; font-size: 0.8rem; font-weight: 700; color: #999;">
            <span>INSTAGRAM</span>
            <span>TWITTER</span>
            <span>LINKEDIN</span>
          </div>
          <p style="color: #eee; font-size: 0.8rem;">&copy; 2026 Mashi Fashion Studio. All rights reserved.</p>
        </div>
      </div>
    </div>
  `;
